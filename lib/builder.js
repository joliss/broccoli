...
Builder.prototype.makeNodeHandler = function(node, _stack) {
  ...
  var labelExtras = []
  if (pluginInterface.nodeType === 'source') labelExtras.push(pluginInterface.sourceDirectory)
  if (pluginInterface.annotation != null) labelExtras.push(pluginInterface.annotation)
